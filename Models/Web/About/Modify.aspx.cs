...
namespace Maticsoft.Web.About
{
	...
	private void ShowInfo(int ID)
	{
		...
		this.chkavg2.Checked=model.avg2;
		this.txtavg3.Text=model.avg3;
		...
		this.txtPicURL6.Text=model.PicURL6;
		this.txtPicURL7.Text=model.PicURL7;
		this.txtPicURL8.Text=model.PicURL8;
		this.txtPicURL9.Text=model.PicURL9;
		this.txtPicURL10.Text=model.PicURL10;
		this.txtPicURL11.Text=model.PicURL11;
		this.txtPicURL12.Text=model.PicURL12;
		this.txtPicURL13.Text=model.PicURL13;
		this.txtWAdress.Text=model.WAdress;
		this.txtAdress.Text=model.Adress;
		this.txtPhone.Text=model.Phone;
		this.txtCPhone.Text=model.CPhone;
		this.txtPostNum.Text=model.PostNum;
		this.txtAPicURL.Text=model.APicURL;
		this.txtavg4.Text=model.avg4;
		this.txtavg5.Text=model.avg5;
		this.chkavg6.Checked=model.avg6;
		this.txtJDtxt1.Text=model.JDtxt1;
		this.txtJDtxt2.Text=model.JDtxt2;
		this.txtJDtxt3.Text=model.JDtxt3;
		this.txtJDtxt4.Text=model.JDtxt4;
		this.txtJDtxt5.Text=model.JDtxt5;
		this.txtWXURL1.Text=model.WXURL1;
		this.txtWXURL2.Text=model.WXURL2;
		this.txtWXURL3.Text=model.WXURL3;
		this.txtJDtxt6.Text=model.JDtxt6;
		this.txtJDtxt7.Text=model.JDtxt7;
		this.txtJDtxt8.Text=model.JDtxt8;
		this.txtJDtxt9.Text=model.JDtxt9;
		this.txtJDtxt10.Text=model.JDtxt10;
		this.txtTitle1.Text=model.Title1;
		this.txtTitle2.Text=model.Title2;
		this.txtTitle3.Text=model.Title3;
		this.txtTitle4.Text=model.Title4;
		this.txtTitle5.Text=model.Title5;
		this.txtTitle7.Text=model.Title7;
